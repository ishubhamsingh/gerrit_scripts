...
GERRIT_HOST="ishubhamsingh@gerrit.aospextended.com"
...
GERRIT_PROJECT_PREFIX="AospExtended/"
...
GERRIT_PROJECT_NAMES="$(grep 'aex' ~/aex2/.repo/manifests/snippets/aex.xml | awk '{print $3}' | awk -F'"' '{print $2}' | uniq)"
